...
test_that("combine_fuel_classes behaves reasonably", {
  ...
  tempDF4 <- data.table(species =c ("Pice_mar", "Pinu_con", "Popu_tre",
                                   "Betu_pap", "Pice_eng", "Pice_gla", "Abie_las"),
                       coef = c(-0.0132, 0.00154, 0.021, -0.0017, -0.0191, -0.0092, -0.0063),
                       sign = c("negative", "positive", "negative", "negative",
                                "negative", "negative", "negative"),
  ...
  tempDF5 <- data.table(species =c ("Popu_bal", "Pinu_con", "Popu_tre",
                                    "Betu_pap", "Pice_eng", "Pice_gla", "Abie_las"),
                        coef = c(0.0132, 0.00154, 0.021, 0.0017, -0.0191, -0.0092, -0.0063),
                        sign = c("positive", "positive", "positive", "positive",
                                 "negative", "negative", "negative"),
                        FuelClass = c("PopBrch", "LdJkPine", "PopBrch", "PopBrch",
                                      "SprcFrLrch", "SprcFrLrch", "SprcFrLrch"),
                        above10PctRelB = c(0.066, 0.625, 0.223, 0.041, 0.095, 0.352, 0.560))
  ...
  tempDF6 <- data.table(species =c ("Popu_bal", "Betu_all", "Pinu_con", "Popu_tre",
                                    "Betu_pap", "Pice_eng", "Pice_gla", "Abie_las"),
                        coef = c(0.0132, -0.023, 0.00154, 0.021, 0.0017, -0.0191, -0.0092, -0.0063),
                        sign = c("positive", "negative", "positive", "positive",
                                 "positive", "negative", "negative", "negative"),
                        FuelClass = c("PopBrch", "PopBrch", "LdJkPine", "PopBrch",
                                      "PopBrch", "SprcFrLrch", "SprcFrLrch", "SprcFrLrch"),
  ...
  tempDF7 <- data.table(species =c ("Popu_bal", "Betu_all", "Pinu_con", "Popu_tre",
                                    "Betu_pap", "Pice_eng", "Pice_gla", "Abie_las"),
                        coef = c(0.0132, -0.023, 0.00154, 0.021, 0.0017, -0.0191, -0.0092, -0.0063),
                        sign = c("positive", "negative", "positive", "positive",
                                 "positive", "negative", "negative", "negative"),
