...
Require(c("magrittr", "dplyr", "PtProcess", "quickPlot",
          "raster", "rgeos", "sp", "SpaDES", "spatstat"))
...
To continue with the example of fire ignitions, the module fireSense_Ignition*Predict* is associated with the fireSense_Ignition*Fit* module.
One possible use of the fireSense_Ignition*Predict* module would be to generate rasters describing in a spatially explicit way the predicted ignition rates.
